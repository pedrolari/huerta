						...
						<div class="widget">
							...
							<div class="body">
								<div class="tagcloud">
									...
									?>
										<a style="font-size: <?php echo $size; ?>pt;" href="index.php?page=productocliente&cat=<?php echo $tag['catpadre'];?>&subcat=<?php echo $tag['cathija'];?>&idproducto=<?php echo $tag['id'];?>&nombre=<?php echo $tag['tag'];?>"><?php echo $tag['tag'];?></a>
									<?php endforeach; ?>
								</div><!-- /.tagcloud -->
							</div><!-- /.body -->
						</div><!-- /.widget -->
