								...
								<div class="tab-content">
									...
									<div id="grid-view" class="products-grid fade tab-pane in active">
										<div class="product-grid-holder">
											...
											$TotalReg=$con->query("SELECT * FROM producto WHERE id_producto IN (SELECT id_producto FROM productos_productor WHERE dni_productor = '".$_SESSION['dni']."')");
											...
											$consulta = "SELECT * FROM producto WHERE id_producto IN (SELECT id_producto FROM productos_productor WHERE dni_productor = '".$_SESSION['dni']."') ORDER BY id_producto ASC LIMIT ".(($compag-1)*$CantidadMostrar)." , ".$CantidadMostrar;
										...
										<div class="pagination-holder">
											...
											/*Sector de Paginacion */
													...
													echo '<li><a href="index.php?page=listaproductos&pag='.$DecrementNum.'">Anterior</a></li>';
													...
													//números  a mostrar
													 ...
													 for($i=$Desde; $i<=$Hasta;$i++){
														...
														if($i<=$TotalRegistro){
														  ...
														  if($i==$compag){
														   echo '<li class="current"><a href="index.php?page=listaproductos&pag='.$i.'">'.$i.'</a></li>';
														  }else {
															echo '<li><a href="index.php?page=listaproductos&pag='.$i.'">'.$i.'</li>';
														  }     		
														}
													 }
													echo '<li><a href="index.php?page=listaproductos&pag='.$IncrimentNum.'">Siguiente</a></li>';
													echo '
