									...
									<div id="grid-view" class="products-grid fade tab-pane in active">
										...
										<div class="pagination-holder">
											...
											/*Sector de Paginacion */
													...
													echo '<li><a href="index.php?page=gridproductoadmin&pag='.$DecrementNum.'&cat='.$cat.'&subcat='.$subcat.'">Anterior</a></li>';
													...
													//números  a mostrar
													 ...
													 for($i=$Desde; $i<=$Hasta;$i++){
														...
														if($i<=$TotalRegistro){
														  ...
														  if($i==$compag){
														   echo '<li class="current"><a href="index.php?page=gridproductoadmin&pag='.$i.'">'.$i.'</a></li>';
														  }else {
															echo '<li><a href="index.php?page=gridproductoadmin&pag='.$i.'">'.$i.'</li>';
														  }     		
														}
													 }
													echo '<li><a href="index.php?page=gridproductoadmin&pag='.$IncrimentNum.'&cat='.$cat.'&subcat='.$subcat.'">Siguiente</a></li>';
													echo '
